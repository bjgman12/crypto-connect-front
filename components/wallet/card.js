...
export default function Card({ balance, email }){
    return(
        <div className='h-40 px-2 py-3 mx-auto font-light text-white border border-gray-400 rounded-md shadow-2xl w-72 bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500'>
            <div className='flex'>
